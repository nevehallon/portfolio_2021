                  ...
                  l = (function d(u, f) {
                    ...
                    for (; b--; )
                      (c = a[b]),
                        3 === (e = c.nodeType)
                          ? f.push(c)
                          : 1 !== e || "ownerSVGElement" in c || h.test(c.nodeName.toLowerCase()) || d(c, f);
                    return f;
                  })(d, []),
                  p = l.length;
                for (; p--; ) {
                  for (
                    e = !1, a = document.createDocumentFragment(), b = l[p], t = b.nodeValue, n = 0;
                    (i = m.exec(t));
...
!(function (c, l) {
  (c.wp = c.wp || {}),
    (c.wp.emoji = new (function () {
      ...
      function i() {
        return (
          !a.implementation.hasFeature || a.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1")
        );
      }
      function s() {
        if (!t) {
      ...
      function f(u, e) {
        var t;
        return !l.supports.everything && n && u && ("string" == typeof u || (u.childNodes && u.childNodes.length))
          ? ((e = e || {}),
            (t = {
